...
var author$project$Graphql$Generator$AnnotatedArg$build = function (returnAnnotation) {
	return A2(author$project$Graphql$Generator$AnnotatedArg$AnnotatedArgs, _List_Nil, returnAnnotation);
};
...
var author$project$Graphql$Generator$AnnotatedArg$prepend = F2(
	function (_n0, annotatedArgs) {
		var annotation = _n0.a;
		var parameterName = _n0.b;
		return _Utils_update(
			annotatedArgs,
			{
				args: A2(
					elm$core$List$cons,
					_Utils_Tuple2(annotation, parameterName),
					annotatedArgs.args)
			});
	});
...
var author$project$Generator$AnnotatedArgTests$all = A2(
	...
	_List_fromArray(
		[
			...
			function (_n0) {
				return A2(
					...
					A2(
						...
						'foo',
						author$project$Graphql$Generator$AnnotatedArg$build('String')));
			}),
			A2(
			elm_explorations$test$Test$test,
			'with arg',
			function (_n1) {
				return A2(
					...
					A2(
						...
						'intToString',
						A2(
							author$project$Graphql$Generator$AnnotatedArg$prepend,
							_Utils_Tuple2('Int', 'n'),
							author$project$Graphql$Generator$AnnotatedArg$build('String'))));
			}),
			A2(
			...
			function (_n2) {
				return A2(
					...
					A2(
						...
						A2(
							author$project$Graphql$Generator$AnnotatedArg$prepend,
							_Utils_Tuple2('(String -> String)', 'mapFn'),
							A2(
								author$project$Graphql$Generator$AnnotatedArg$prepend,
								_Utils_Tuple2('Int', 'n'),
								author$project$Graphql$Generator$AnnotatedArg$build('String')))));
			...
			A2(
			elm_explorations$test$Test$test,
			'two args built with `buildWithArgs`',
			function (_n3) {
				return A2(
					elm_explorations$test$Expect$equal,
					'mapInt : (String -> String) -> Int -> String\nmapInt mapFn n =\n',
...
var author$project$Generator$DocCommentTests$all = A2(
	elm_explorations$test$Test$describe,
		...
		[
			...
			function (_n0) {
				return A2(
					...
					author$project$Graphql$Generator$DocComment$generate(
						{
							args: _List_Nil,
							description: elm$core$Maybe$Just('A human in the star wars universe.'),
							name: author$project$Graphql$Parser$CamelCaseName$build('human'),
							typeRef: A2(
								author$project$Graphql$Parser$Type$TypeReference,
								author$project$Graphql$Parser$Type$InterfaceRef('Human'),
					...
					author$project$Graphql$Generator$DocComment$generate(
						{
							args: _List_fromArray(
								[
									{
									description: elm$core$Maybe$Just('The human\'s id.'),
									name: author$project$Graphql$Parser$CamelCaseName$build('id'),
									typeRef: A2(
										author$project$Graphql$Parser$Type$TypeReference,
			...
			A2(
			elm_explorations$test$Test$test,
			'field with arg with no description',
			function (_n2) {
				return A2(
					elm_explorations$test$Expect$equal,
					'{-| A human in the star wars universe.\n-}\n',
			...
			A2(
			elm_explorations$test$Test$test,
			'field with no field description but with arg description',
			function (_n3) {
				return A2(
					elm_explorations$test$Expect$equal,
					'{-|\n\n  - id - The human\'s id.\n\n-}\n',
...
var author$project$Generator$EnumTests$all = A2(
	elm_explorations$test$Test$describe,
	'enum',
	_List_fromArray(
		[
			...
			function (_n0) {
				return A2(
					...
					'type Beverage\n    = Tea\n    | Coffee\n',
					A2(
						author$project$Graphql$Generator$Enum$enumType,
						author$project$Graphql$Parser$ClassCaseName$build('Beverage'),
						_List_fromArray(
							[
								{
								description: elm$core$Maybe$Nothing,
								name: author$project$Graphql$Parser$ClassCaseName$build('Tea')
							},
								{
								description: elm$core$Maybe$Nothing,
								name: author$project$Graphql$Parser$ClassCaseName$build('Coffee')
							}
							])));
			})
		]));
var author$project$Generator$FieldTests$meField = {
	args: _List_Nil,
	description: elm$core$Maybe$Nothing,
	name: author$project$Graphql$Parser$CamelCaseName$build('me'),
	typeRef: A2(
		author$project$Graphql$Parser$Type$TypeReference,
		author$project$Graphql$Parser$Type$Scalar(author$project$Graphql$Parser$Scalar$String),
		author$project$Graphql$Parser$Type$NonNullable)
};
var author$project$Graphql$Generator$Context$context = function (_n0) {
	var query = _n0.query;
	var mutation = _n0.mutation;
	var apiSubmodule = _n0.apiSubmodule;
	var interfaces = _n0.interfaces;
	var subscription = _n0.subscription;
	return {
		apiSubmodule: apiSubmodule,
		interfaces: interfaces,
		mutation: A2(elm$core$Maybe$map, author$project$Graphql$Parser$ClassCaseName$build, mutation),
		query: author$project$Graphql$Parser$ClassCaseName$build(query),
		subscription: A2(elm$core$Maybe$map, author$project$Graphql$Parser$ClassCaseName$build, subscription)
	};
};
...
var author$project$Generator$FieldTests$all = A2(
	elm_explorations$test$Test$describe,
	'field generator',
	_List_fromArray(
		[
			A2(
			elm_explorations$test$Test$test,
			'simple scalar converts for query',
			function (_n0) {
				return A2(
					elm_explorations$test$Expect$equal,
					...
					A3(
						...
						author$project$Graphql$Generator$Context$context(
							{
								apiSubmodule: _List_fromArray(
									['Api']),
								interfaces: elm$core$Dict$empty,
								mutation: elm$core$Maybe$Nothing,
								query: 'RootQueryObject',
								subscription: elm$core$Maybe$Nothing
							}),
						author$project$Graphql$Parser$ClassCaseName$build('RootQueryObject'),
						author$project$Generator$FieldTests$meField));
			}),
			A2(
			elm_explorations$test$Test$test,
			'converts for object',
			function (_n1) {
				return A2(
					...
					A3(
						...
						author$project$Graphql$Parser$ClassCaseName$build('Foo'),
						author$project$Generator$FieldTests$meField));
			}),
			A2(
			elm_explorations$test$Test$test,
			'simple object with no args',
			function (_n2) {
				return A2(
					elm_explorations$test$Expect$equal,
					...
					A3(
						...
						author$project$Graphql$Parser$ClassCaseName$build('RootQuery'),
						{
							args: _List_Nil,
							description: elm$core$Maybe$Nothing,
							name: author$project$Graphql$Parser$CamelCaseName$build('droid'),
							typeRef: A2(
								author$project$Graphql$Parser$Type$TypeReference,
								author$project$Graphql$Parser$Type$ObjectRef('Droid'),
								author$project$Graphql$Parser$Type$NonNullable)
						}));
			}),
			A2(
			elm_explorations$test$Test$test,
			'simple interface with no args',
			function (_n3) {
				return A2(
					elm_explorations$test$Expect$equal,
					...
					A3(
								...
								interfaces: elm$core$Dict$fromList(
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													author$project$Graphql$Parser$ClassCaseName$build('Human'),
													author$project$Graphql$Parser$ClassCaseName$build('Droid')
												]))
										])),
								mutation: elm$core$Maybe$Nothing,
								query: 'RootQuery',
						...
						author$project$Graphql$Parser$ClassCaseName$build('RootQuery'),
						{
							args: _List_Nil,
							description: elm$core$Maybe$Nothing,
							name: author$project$Graphql$Parser$CamelCaseName$build('hero'),
							typeRef: A2(
								author$project$Graphql$Parser$Type$TypeReference,
								author$project$Graphql$Parser$Type$InterfaceRef('Character'),
								author$project$Graphql$Parser$Type$NonNullable)
						}));
			}),
			A2(
			elm_explorations$test$Test$test,
			'simple object with no args for object',
			function (_n4) {
				return A2(
					elm_explorations$test$Expect$equal,
				...
				return A2(
					...
					A3(
						...
						author$project$Graphql$Parser$ClassCaseName$build('RootQuery'),
						{
							...
							typeRef: A2(
								author$project$Graphql$Parser$Type$TypeReference,
								author$project$Graphql$Parser$Type$ObjectRef('Human'),
								author$project$Graphql$Parser$Type$NonNullable)
						}));
			}),
			A2(
						...
						author$project$Graphql$Parser$ClassCaseName$build('RootQuery'),
						{
							args: _List_fromArray(
								[
									{
									description: elm$core$Maybe$Nothing,
									name: author$project$Graphql$Parser$CamelCaseName$build('contains'),
									typeRef: A2(
										author$project$Graphql$Parser$Type$TypeReference,
										author$project$Graphql$Parser$Type$Scalar(author$project$Graphql$Parser$Scalar$String),
							...
							description: elm$core$Maybe$Nothing,
							name: author$project$Graphql$Parser$CamelCaseName$build('menuItems'),
							typeRef: A2(
								author$project$Graphql$Parser$Type$TypeReference,
								author$project$Graphql$Parser$Type$List(
									A2(
										author$project$Graphql$Parser$Type$TypeReference,
										author$project$Graphql$Parser$Type$ObjectRef('MenuItem'),
										author$project$Graphql$Parser$Type$NonNullable)),
								author$project$Graphql$Parser$Type$NonNullable)
						}));
			}),
			...
			function (_n8) {
				return A2(
					...
					A3(
						...
						author$project$Graphql$Parser$ClassCaseName$build('TreeEntry'),
						{
							args: _List_Nil,
							description: elm$core$Maybe$Nothing,
							name: author$project$Graphql$Parser$CamelCaseName$build('type'),
							typeRef: A2(
								author$project$Graphql$Parser$Type$TypeReference,
								author$project$Graphql$Parser$Type$Scalar(author$project$Graphql$Parser$Scalar$String),
								author$project$Graphql$Parser$Type$NonNullable)
...
var author$project$Generator$ImportsTests$objectRef = A2(
	author$project$Graphql$Parser$Type$TypeReference,
	author$project$Graphql$Parser$Type$ObjectRef('Foo'),
	author$project$Graphql$Parser$Type$NonNullable);
var author$project$Generator$ImportsTests$listOfObjectRef = A2(
	author$project$Graphql$Parser$Type$TypeReference,
	author$project$Graphql$Parser$Type$List(author$project$Generator$ImportsTests$objectRef),
	author$project$Graphql$Parser$Type$NonNullable);
var author$project$Generator$ImportsTests$scalarRef = A2(
	author$project$Graphql$Parser$Type$TypeReference,
	author$project$Graphql$Parser$Type$Scalar(author$project$Graphql$Parser$Scalar$String),
	author$project$Graphql$Parser$Type$NonNullable);
var author$project$Generator$ImportsTests$listOfScalarRef = A2(
	author$project$Graphql$Parser$Type$TypeReference,
	author$project$Graphql$Parser$Type$List(author$project$Generator$ImportsTests$scalarRef),
	author$project$Graphql$Parser$Type$NonNullable);
...
var author$project$Generator$ImportsTests$all = A2(
	elm_explorations$test$Test$describe,
	'group',
	_List_fromArray(
		[
			A2(
			elm_explorations$test$Test$test,
			'scalar has no imports',
			function (_n0) {
				return A2(
					elm_explorations$test$Expect$equal,
					elm$core$Maybe$Nothing,
					A2(
						author$project$Graphql$Generator$Imports$imports,
						_List_fromArray(
							['Api']),
						author$project$Generator$ImportsTests$scalarRef));
			}),
			A2(
			elm_explorations$test$Test$test,
			'list of scalars has no imports',
			function (_n1) {
				return A2(
					elm_explorations$test$Expect$equal,
					elm$core$Maybe$Nothing,
					A2(
						...
						_List_fromArray(
							['Api']),
						author$project$Generator$ImportsTests$listOfScalarRef));
			}),
			A2(
			elm_explorations$test$Test$test,
			'object refs don\'t need imports',
			function (_n2) {
				return A2(
					elm_explorations$test$Expect$equal,
					elm$core$Maybe$Nothing,
					A2(
						...
						_List_fromArray(
							['Api']),
						author$project$Generator$ImportsTests$objectRef));
			}),
			A2(
			elm_explorations$test$Test$test,
			'list of object ref don\'t need imports',
			function (_n3) {
				return A2(
					elm_explorations$test$Expect$equal,
					elm$core$Maybe$Nothing,
					A2(
						...
						_List_fromArray(
							['Api']),
						author$project$Generator$ImportsTests$listOfObjectRef));
			}),
			A2(
			elm_explorations$test$Test$test,
			'enum ref needs import',
			function (_n4) {
				return A2(
					elm_explorations$test$Expect$equal,
					elm$core$Maybe$Just(
			...
			A2(
			elm_explorations$test$Test$test,
			'filters out its own module name',
			function (_n5) {
				return A2(
					elm_explorations$test$Expect$equal,
					_List_Nil,
...
var author$project$Generator$InputObjectLoopsTests$field = F2(
	function (inputObjectName, fieldName) {
		return {
			args: _List_Nil,
			description: elm$core$Maybe$Nothing,
			name: author$project$Graphql$Parser$CamelCaseName$build(fieldName),
			typeRef: A2(
				author$project$Graphql$Parser$Type$TypeReference,
...
var author$project$Generator$InputObjectLoopsTests$fieldListRef = F2(
	function (inputObjectName, fieldName) {
		return {
			args: _List_Nil,
			description: elm$core$Maybe$Nothing,
...
var author$project$Graphql$Generator$InputObjectLoops$any = function (typeDefs) {
	return A2(
		elm$core$List$any,
		author$project$Graphql$Generator$InputObjectLoops$hasLoop(typeDefs),
		typeDefs);
};
...
var author$project$Generator$InputObjectLoopsTests$all = A2(
	elm_explorations$test$Test$describe,
	'input object loops',
	_List_fromArray(
		[
			A2(
			elm_explorations$test$Test$test,
			'no input objects in schema',
			function (_n0) {
				return A2(
					elm_explorations$test$Expect$equal,
					false,
					author$project$Graphql$Generator$InputObjectLoops$any(
						_List_fromArray(
							[
								A3(
								author$project$Graphql$Parser$Type$TypeDefinition,
								author$project$Graphql$Parser$ClassCaseName$build('SomeScalar'),
								author$project$Graphql$Parser$Type$ScalarType,
								elm$core$Maybe$Nothing)
							])));
			}),
			A2(
					...
					author$project$Graphql$Generator$InputObjectLoops$any(
						_List_fromArray(
							[
								A3(
								author$project$Graphql$Parser$Type$TypeDefinition,
								author$project$Graphql$Parser$ClassCaseName$build('MyInputObject'),
								author$project$Graphql$Parser$Type$InputObjectType(
									_List_fromArray(
										[
											A2(author$project$Generator$InputObjectLoopsTests$field, 'DifferentInputObject', 'fieldName')
										])),
								elm$core$Maybe$Nothing)
							])));
			}),
					...
					author$project$Graphql$Generator$InputObjectLoops$any(
						_List_fromArray(
							[
								A3(
								author$project$Graphql$Parser$Type$TypeDefinition,
								author$project$Graphql$Parser$ClassCaseName$build('RecursiveInputObject'),
								author$project$Graphql$Parser$Type$InputObjectType(
									_List_fromArray(
										[
											A2(author$project$Generator$InputObjectLoopsTests$field, 'RecursiveInputObject', 'fieldName')
										])),
								elm$core$Maybe$Nothing)
							])));
			}),
					...
					author$project$Graphql$Generator$InputObjectLoops$any(
						_List_fromArray(
							[
								A3(
								author$project$Graphql$Parser$Type$TypeDefinition,
								author$project$Graphql$Parser$ClassCaseName$build('CircularInputObjectOne'),
								author$project$Graphql$Parser$Type$InputObjectType(
									_List_fromArray(
										[
											A2(author$project$Generator$InputObjectLoopsTests$field, 'CircularInputObjectTwo', 'fieldNameOne')
										])),
								elm$core$Maybe$Nothing),
								A3(
								author$project$Graphql$Parser$Type$TypeDefinition,
								author$project$Graphql$Parser$ClassCaseName$build('CircularInputObjectTwo'),
								author$project$Graphql$Parser$Type$InputObjectType(
									_List_fromArray(
										[
											A2(author$project$Generator$InputObjectLoopsTests$field, 'CircularInputObjectOne', 'fieldNameTwo')
										])),
								elm$core$Maybe$Nothing)
							])));
			}),
						...
						_List_fromArray(
							[
								...
								author$project$Graphql$Parser$Type$InputObjectType(
									_List_fromArray(
										[
											A2(author$project$Generator$InputObjectLoopsTests$field, 'CircularInputObjectThree', 'fieldNameTwo')
										])),
								elm$core$Maybe$Nothing),
								A3(
								author$project$Graphql$Parser$Type$TypeDefinition,
								author$project$Graphql$Parser$ClassCaseName$build('CircularInputObjectThree'),
								author$project$Graphql$Parser$Type$ScalarType,
								elm$core$Maybe$Nothing)
							])));
			}),
						...
						_List_fromArray(
							[
								...
								author$project$Graphql$Parser$Type$InputObjectType(
									_List_fromArray(
										[
											A2(author$project$Generator$InputObjectLoopsTests$field, 'CircularInputObjectOne', 'fieldNameThree')
										])),
								elm$core$Maybe$Nothing)
							])));
			}),
			A2(
			elm_explorations$test$Test$test,
			'nested loops through list reference',
			function (_n6) {
				return A2(
					elm_explorations$test$Expect$equal,
					true,
						...
						_List_fromArray(
							[
								...
								author$project$Graphql$Parser$Type$InputObjectType(
									_List_fromArray(
										[
											A2(author$project$Generator$InputObjectLoopsTests$fieldListRef, 'CircularInputObjectThree', 'fieldNameTwo')
										])),
								elm$core$Maybe$Nothing),
								A3(
								author$project$Graphql$Parser$Type$TypeDefinition,
			...
			A2(
			elm_explorations$test$Test$test,
			'deeploy nested loops through list reference',
			function (_n7) {
				return A2(
					elm_explorations$test$Expect$equal,
					true,
			...
			A2(
			elm_explorations$test$Test$test,
			'recursive loop through list reference',
			function (_n8) {
				return A2(
					elm_explorations$test$Expect$equal,
					true,
					author$project$Graphql$Generator$InputObjectLoops$any(
						_List_fromArray(
							[
								A3(
								author$project$Graphql$Parser$Type$TypeDefinition,
								author$project$Graphql$Parser$ClassCaseName$build('CircularInputObject'),
								author$project$Graphql$Parser$Type$InputObjectType(
									_List_fromArray(
										[
											A2(author$project$Generator$InputObjectLoopsTests$fieldListRef, 'CircularInputObject', 'recursiveListField')
										])),
								elm$core$Maybe$Nothing)
							])));
			})
		]));
var author$project$Generator$ModuleNameTests$all = A2(
	elm_explorations$test$Test$describe,
	'module name',
	_List_fromArray(
		[
			...
			function (_n0) {
				return A2(
					...
					A2(
						...
						author$project$Graphql$Parser$ClassCaseName$build('RootQueryType')));
			})
		]));
var author$project$Generator$NormalizeTests$all = A2(
	elm_explorations$test$Test$describe,
	'normalize',
	_List_fromArray(
		[
			A2(
			elm_explorations$test$Test$test,
			'leaves valid names untouched',
			function (_n0) {
				return A2(
					elm_explorations$test$Expect$equal,
					'validCamelCaseName',
					author$project$Graphql$Generator$Normalize$decapitalized('validCamelCaseName'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'leaves valid snake_case names untouched',
			function (_n1) {
				return A2(
					elm_explorations$test$Expect$equal,
					'year_budget',
					author$project$Graphql$Generator$Normalize$decapitalized('year_budget'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'corrects casing on otherwise valid snake_case names',
			function (_n2) {
				return A2(
					elm_explorations$test$Expect$equal,
					'Year_budget',
					author$project$Graphql$Generator$Normalize$capitalized('year_budget'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'already normalized module name',
			function (_n3) {
				return A2(
					elm_explorations$test$Expect$equal,
					'MyInterface',
					author$project$Graphql$Generator$Normalize$capitalized('MyInterface'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'module name with leading underscore',
			function (_n4) {
				return A2(
					elm_explorations$test$Expect$equal,
					'ModelMutationType_',
					author$project$Graphql$Generator$Normalize$capitalized('_ModelMutationType'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'normalizes all uppercase names to capitalized',
			function (_n5) {
				return A2(
					elm_explorations$test$Expect$equal,
					'Enumeration',
					author$project$Graphql$Generator$Normalize$capitalized('ENUMERATION'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'uppercase with leading underscore',
			function (_n6) {
				return A2(
					elm_explorations$test$Expect$equal,
					'My_Module_Name_',
					author$project$Graphql$Generator$Normalize$capitalized('_My_Module_Name'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'normalizes enums that follow convention into class case',
			function (_n7) {
				return A2(
					elm_explorations$test$Expect$equal,
					'MobileWeb',
					author$project$Graphql$Generator$Normalize$capitalized('MOBILE_WEB'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'leaves unconventional but valid names untouched',
			function (_n8) {
				return A2(
					elm_explorations$test$Expect$equal,
					'BillingSubscriptions_UpdateBillingEmailsPayload',
					author$project$Graphql$Generator$Normalize$capitalized('BillingSubscriptions_UpdateBillingEmailsPayload'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'fixes first letter only in all lowercase',
			function (_n9) {
				return A2(
					elm_explorations$test$Expect$equal,
					'Hello',
					author$project$Graphql$Generator$Normalize$capitalized('hello'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'fixes single letter names',
			function (_n10) {
				return A2(
					elm_explorations$test$Expect$equal,
					'x',
					author$project$Graphql$Generator$Normalize$decapitalized('X'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'puts multiple leading underscores to the back',
			function (_n11) {
				return A2(
					elm_explorations$test$Expect$equal,
					'x________',
					author$project$Graphql$Generator$Normalize$decapitalized('________x'));
			}),
			A2(
			elm_explorations$test$Test$describe,
			'reserved words',
				...
				[
					...
					function (_n12) {
						return A2(
							elm_explorations$test$Expect$equal,
							'type_',
							author$project$Graphql$Generator$Normalize$decapitalized('type'));
					}),
					A2(
					elm_explorations$test$Test$test,
					'where',
					function (_n13) {
						return A2(
							elm_explorations$test$Expect$equal,
							'where_',
							author$project$Graphql$Generator$Normalize$decapitalized('where'));
					}),
					A2(
					elm_explorations$test$Test$test,
					'of',
					function (_n14) {
						return A2(
							elm_explorations$test$Expect$equal,
							'of_',
							author$project$Graphql$Generator$Normalize$decapitalized('of'));
					}),
					A2(
					elm_explorations$test$Test$test,
					'infix',
					function (_n15) {
						return A2(
							elm_explorations$test$Expect$equal,
							'infix_',
							author$project$Graphql$Generator$Normalize$decapitalized('infix'));
					})
				]))
		]));
var author$project$Generator$OptionalArgsTests$expectResult = F2(
	function (expected, actual) {
		return A2(
			elm_explorations$test$Expect$equal,
			elm$core$Maybe$Just(expected),
			A2(
				elm$core$Maybe$map,
				function (value) {
					return {letBindings: value.letBindings, typeAlias: value.typeAlias.body};
				},
				actual));
	});
var author$project$Graphql$Parser$Scalar$Int = {$: 'Int'};
var author$project$Generator$OptionalArgsTests$all = A2(
	elm_explorations$test$Test$describe,
	'optional args generator',
	_List_fromArray(
		[
			A2(
			elm_explorations$test$Test$test,
			...
			function (_n0) {
				return A2(
					...
					elm$core$Maybe$Nothing,
					A2(
						author$project$Graphql$Generator$OptionalArgs$generate,
						_List_fromArray(
							['Api']),
						_List_Nil));
			}),
			A2(
			elm_explorations$test$Test$test,
			'no optional args, only required',
			function (_n1) {
				return A2(
					elm_explorations$test$Expect$equal,
					elm$core$Maybe$Nothing,
			...
			A2(
			elm_explorations$test$Test$test,
			'with an optional string arg',
			function (_n2) {
				return A2(
					author$project$Generator$OptionalArgsTests$expectResult,
					{
						letBindings: _List_fromArray(
							[
								_Utils_Tuple2('filledInOptionals', 'fillInOptionals { contains = Absent }'),
								_Utils_Tuple2('optionalArgs', '[ Argument.optional "contains" filledInOptionals.contains (Encode.string) ]\n                |> List.filterMap identity')
							]),
			...
			A2(
			elm_explorations$test$Test$test,
			'with multiple optional string args',
			function (_n3) {
				return A2(
					author$project$Generator$OptionalArgsTests$expectResult,
					{
						letBindings: _List_fromArray(
							[
								_Utils_Tuple2('filledInOptionals', 'fillInOptionals { id = Absent, contains = Absent }'),
								_Utils_Tuple2('optionalArgs', '[ Argument.optional "id" filledInOptionals.id (Encode.string), Argument.optional "contains" filledInOptionals.contains (Encode.string) ]\n                |> List.filterMap identity')
							]),
			...
			function (_n4) {
				return A2(
					author$project$Generator$OptionalArgsTests$expectResult,
					{
						letBindings: _List_fromArray(
							[
								_Utils_Tuple2('filledInOptionals', 'fillInOptionals { first = Absent }'),
								_Utils_Tuple2('optionalArgs', '[ Argument.optional "first" filledInOptionals.first (Encode.int) ]\n                |> List.filterMap identity')
							]),
					...
					A2(
						...
						_List_fromArray(
							[
								{
								description: elm$core$Maybe$Nothing,
								name: author$project$Graphql$Parser$CamelCaseName$build('first'),
								typeRef: A2(
									author$project$Graphql$Parser$Type$TypeReference,
									author$project$Graphql$Parser$Type$Scalar(author$project$Graphql$Parser$Scalar$Int),
									author$project$Graphql$Parser$Type$Nullable)
							}
							])));
			}),
			...
			function (_n5) {
				return A2(
					author$project$Generator$OptionalArgsTests$expectResult,
					{
						letBindings: _List_fromArray(
							[
								_Utils_Tuple2('filledInOptionals', 'fillInOptionals { episode = Absent }'),
								_Utils_Tuple2('optionalArgs', '[ Argument.optional "episode" filledInOptionals.episode ((Encode.enum Api.Enum.Episode.toString)) ]\n                |> List.filterMap identity')
							]),
					...
					A2(
						...
						_List_fromArray(
							[
								{
								description: elm$core$Maybe$Nothing,
								name: author$project$Graphql$Parser$CamelCaseName$build('episode'),
								typeRef: A2(
									author$project$Graphql$Parser$Type$TypeReference,
									author$project$Graphql$Parser$Type$EnumRef(
										author$project$Graphql$Parser$ClassCaseName$build('Episode')),
									author$project$Graphql$Parser$Type$Nullable)
							}
							])));
			})
		]));
var author$project$Generator$RequiredArgsTests$expectResult = F2(
	function (expected, actual) {
		return A2(
			elm_explorations$test$Expect$equal,
			elm$core$Maybe$Just(expected),
			A2(
				elm$core$Maybe$map,
				function (value) {
					return {list: value.list, typeAlias: value.typeAlias.body};
				},
				actual));
	});
var author$project$Generator$RequiredArgsTests$idArg = {
	description: elm$core$Maybe$Nothing,
	name: author$project$Graphql$Parser$CamelCaseName$build('id'),
	typeRef: A2(
		author$project$Graphql$Parser$Type$TypeReference,
...
var author$project$Generator$RequiredArgsTests$nameArg = {
	description: elm$core$Maybe$Nothing,
...
var author$project$Generator$RequiredArgsTests$numbersArg = {
	description: elm$core$Maybe$Nothing,
	name: author$project$Graphql$Parser$CamelCaseName$build('numbers'),
	typeRef: A2(
		author$project$Graphql$Parser$Type$TypeReference,
		author$project$Graphql$Parser$Type$List(
			A2(
...
var author$project$Generator$RequiredArgsTests$all = A2(
	elm_explorations$test$Test$describe,
	'required argmument generators',
	_List_fromArray(
		[
			A2(
			elm_explorations$test$Test$test,
			...
			function (_n0) {
				return A2(
					elm_explorations$test$Expect$equal,
					elm$core$Maybe$Nothing,
					A2(author$project$Graphql$Generator$RequiredArgs$generate, _List_Nil, _List_Nil));
			}),
			A2(
			elm_explorations$test$Test$test,
			'all nullable arguments',
			function (_n1) {
				return A2(
					elm_explorations$test$Expect$equal,
					elm$core$Maybe$Nothing,
					A2(
						author$project$Graphql$Generator$RequiredArgs$generate,
						_List_Nil,
						_List_fromArray(
							[
								{
			...
			function (_n2) {
				return A2(
					author$project$Generator$RequiredArgsTests$expectResult,
					{list: '[ Argument.required "id" requiredArgs.id (Encode.string) ]', typeAlias: '{ id : String }'},
					A2(
						author$project$Graphql$Generator$RequiredArgs$generate,
						_List_Nil,
						_List_fromArray(
							[author$project$Generator$RequiredArgsTests$idArg])));
			}),
			A2(
			elm_explorations$test$Test$test,
			'composite',
			function (_n3) {
				return A2(
					author$project$Generator$RequiredArgsTests$expectResult,
					{list: '[ Argument.required "numbers" requiredArgs.numbers (Encode.int |> Encode.list) ]', typeAlias: '{ numbers : (List Int) }'},
					A2(
						author$project$Graphql$Generator$RequiredArgs$generate,
						_List_Nil,
						_List_fromArray(
							[author$project$Generator$RequiredArgsTests$numbersArg])));
			}),
			A2(
			elm_explorations$test$Test$test,
			'multiple primitives',
			function (_n4) {
				return A2(
					author$project$Generator$RequiredArgsTests$expectResult,
					{list: '[ Argument.required "id" requiredArgs.id (Encode.string), Argument.required "name" requiredArgs.name (Encode.string) ]', typeAlias: '{ id : String, name : String }'},
					A2(
						author$project$Graphql$Generator$RequiredArgs$generate,
						_List_Nil,
						_List_fromArray(
							[author$project$Generator$RequiredArgsTests$idArg, author$project$Generator$RequiredArgsTests$nameArg])));
			}),
			A2(
			elm_explorations$test$Test$test,
			...
			function (_n5) {
				return A2(
					author$project$Generator$RequiredArgsTests$expectResult,
					{list: '[ Argument.required "type" requiredArgs.type_ (Encode.string) ]', typeAlias: '{ type_ : String }'},
					A2(
						author$project$Graphql$Generator$RequiredArgs$generate,
						_List_Nil,
						_List_fromArray(
...
var author$project$Generator$TypeLockDefinitionsTests$all = A2(
	elm_explorations$test$Test$describe,
	'object types generator',
	_List_fromArray(
		[
			A2(
			elm_explorations$test$Test$test,
			'generates placeholders for types with no definitions',
			function (_n0) {
				return A2(
					elm_explorations$test$Expect$equal,
					_List_fromArray(
			...
			A2(
			elm_explorations$test$Test$test,
			'generates imports for interfaces',
			function (_n1) {
				return A2(
					elm_explorations$test$Expect$equal,
					_List_fromArray(
					...
					A2(
						...
						_List_fromArray(
							[
								...
								author$project$Graphql$Parser$Type$typeDefinition,
								'MyObject',
								author$project$Graphql$Parser$Type$ObjectType(_List_Nil),
								elm$core$Maybe$Nothing),
								A3(
								author$project$Graphql$Parser$Type$typeDefinition,
								'MyInterface',
								A2(author$project$Graphql$Parser$Type$InterfaceType, _List_Nil, _List_Nil),
								elm$core$Maybe$Nothing)
							])));
			})
		]));
...
var author$project$Parser$DecodeTests$all = A2(
	elm_explorations$test$Test$describe,
	'decoder - top-level',
	_List_fromArray(
		[
				...
				return A2(
					...
					elm$core$Result$Ok(
						A3(
							author$project$Graphql$Parser$Type$typeDefinition,
							'Weather',
							author$project$Graphql$Parser$Type$EnumType(
								_List_fromArray(
									[
										{
										description: elm$core$Maybe$Nothing,
										name: author$project$Graphql$Parser$ClassCaseName$build('CLOUDY')
									},
										{
										description: elm$core$Maybe$Nothing,
										name: author$project$Graphql$Parser$ClassCaseName$build('SUNNY')
									}
									])),
							elm$core$Maybe$Nothing)),
					A2(elm$json$Json$Decode$decodeString, author$project$Graphql$Parser$Type$decoder, '\n                 {\n                           "possibleTypes": null,\n                           "name": "Weather",\n                           "kind": "ENUM",\n                           "interfaces": null,\n                           "inputFields": null,\n                           "fields": null,\n                           "enumValues": [\n                             {\n                               "name": "CLOUDY",\n                               "isDeprecated": false,\n                               "description": null,\n                               "deprecationReason": null\n                             },\n                             {\n                               "name": "SUNNY",\n                               "isDeprecated": false,\n                               "description": null,\n                               "deprecationReason": null\n                             }\n                           ]\n                         }\n               '));
			}),
			A2(
			elm_explorations$test$Test$test,
			'scalars',
			function (_n1) {
				return A2(
					elm_explorations$test$Expect$equal,
					elm$core$Result$Ok(
						A3(author$project$Graphql$Parser$Type$typeDefinition, 'Date', author$project$Graphql$Parser$Type$ScalarType, elm$core$Maybe$Nothing)),
					A2(elm$json$Json$Decode$decodeString, author$project$Graphql$Parser$Type$decoder, '\n                {\n                          "possibleTypes": null,\n                          "name": "Date",\n                          "kind": "SCALAR",\n                          "interfaces": null,\n                          "inputFields": null,\n                          "fields": null,\n                          "enumValues": null\n                        }\n                              '));
			}),
			A2(
			elm_explorations$test$Test$test,
				...
				return A2(
					...
					elm$core$Result$Ok(
						A3(
							author$project$Graphql$Parser$Type$typeDefinition,
							'MenuItem',
							author$project$Graphql$Parser$Type$ObjectType(
								_List_fromArray(
									[
										{
										args: _List_Nil,
										description: elm$core$Maybe$Nothing,
										name: author$project$Graphql$Parser$CamelCaseName$build('description'),
										typeRef: A2(
											author$project$Graphql$Parser$Type$TypeReference,
											author$project$Graphql$Parser$Type$Scalar(author$project$Graphql$Parser$Scalar$String),
											author$project$Graphql$Parser$Type$NonNullable)
										...
										typeRef: A2(
											author$project$Graphql$Parser$Type$TypeReference,
											author$project$Graphql$Parser$Type$Scalar(
												author$project$Graphql$Parser$Scalar$Custom(
													author$project$Graphql$Parser$ClassCaseName$build('ID'))),
											author$project$Graphql$Parser$Type$NonNullable)
									},
										{
										args: _List_Nil,
							...
							author$project$Graphql$Parser$Type$ObjectType(
								_List_fromArray(
									[
										{
										args: _List_Nil,
										description: elm$core$Maybe$Just('A list of users who have starred this starrable.'),
										name: author$project$Graphql$Parser$CamelCaseName$build('stargazers'),
										typeRef: A2(
											author$project$Graphql$Parser$Type$TypeReference,
											author$project$Graphql$Parser$Type$ObjectRef('StargazerConnection'),
											author$project$Graphql$Parser$Type$NonNullable)
									}
									])),
							elm$core$Maybe$Nothing)),
							...
							A2(
								...
								_List_fromArray(
									[
										...
										args: _List_Nil,
										description: elm$core$Maybe$Nothing,
										name: author$project$Graphql$Parser$CamelCaseName$build('friends'),
										typeRef: A2(
											author$project$Graphql$Parser$Type$TypeReference,
											author$project$Graphql$Parser$Type$List(
												A2(
									...
									[
										...
										args: _List_fromArray(
											[
												{
												description: elm$core$Maybe$Nothing,
												name: author$project$Graphql$Parser$CamelCaseName$build('filterOptions'),
												typeRef: A2(
													author$project$Graphql$Parser$Type$TypeReference,
													author$project$Graphql$Parser$Type$InputObjectRef(
														author$project$Graphql$Parser$ClassCaseName$build('FilterOptions')),
													author$project$Graphql$Parser$Type$NonNullable)
											}
											]),
										description: elm$core$Maybe$Nothing,
							...
							A2(
								...
								_List_fromArray(
									[
										{
										args: _List_Nil,
										description: elm$core$Maybe$Just('The id of the character.'),
										name: author$project$Graphql$Parser$CamelCaseName$build('id'),
										typeRef: A2(
											author$project$Graphql$Parser$Type$TypeReference,
											author$project$Graphql$Parser$Type$Scalar(author$project$Graphql$Parser$Scalar$String),
										...
										{
										args: _List_Nil,
										description: elm$core$Maybe$Just('The name of the character.'),
										name: author$project$Graphql$Parser$CamelCaseName$build('name'),
										typeRef: A2(
											author$project$Graphql$Parser$Type$TypeReference,
											author$project$Graphql$Parser$Type$Scalar(author$project$Graphql$Parser$Scalar$String),
										...
										{
										args: _List_Nil,
										description: elm$core$Maybe$Just('The friends of the character, or an empty list if they have none.'),
										name: author$project$Graphql$Parser$CamelCaseName$build('friends'),
										typeRef: A2(
											author$project$Graphql$Parser$Type$TypeReference,
											author$project$Graphql$Parser$Type$List(
										...
										{
										args: _List_Nil,
										description: elm$core$Maybe$Just('Which movies they appear in.'),
										name: author$project$Graphql$Parser$CamelCaseName$build('appearsIn'),
										typeRef: A2(
											author$project$Graphql$Parser$Type$TypeReference,
											author$project$Graphql$Parser$Type$List(
												A2(
...
var author$project$Test$Runner$Node$init = function (_n0) {
	var startTime = _n0.startTime;
...
var author$project$Test$Runner$Node$dispatch = F2(
	function (model, startTime) {
		...
		if (_n0.$ === 'Nothing') {
			...
			var labels = _n0.a.labels;
			var run = _n0.a.run;
			var outcomes = author$project$Test$Reporter$TestResults$outcomesFromExpectations(
				run(_Utils_Tuple0));
			return A2(
				elm$core$Task$perform,
				A3(author$project$Test$Runner$Node$Complete, labels, outcomes, startTime),
				elm$time$Time$now);
		}
	});
...
var author$project$Test$Runner$Node$App$Init = function (a) {
	return {$: 'Init', a: a};
};
var author$project$Test$Runner$Node$App$Uninitialized = F2(
	function (a, b) {
		return {$: 'Uninitialized', a: a, b: b};
	});
var author$project$Test$Runner$Node$App$defaultRunCount = 100;
var author$project$Test$Runner$Node$App$Initialized = F2(
	function (a, b) {
		return {$: 'Initialized', a: a, b: b};
	});
var author$project$Test$Runner$Node$App$SubMsg = function (a) {
	return {$: 'SubMsg', a: a};
};
...
var author$project$Test$Runner$Node$App$timeToNumericSeed = function (time) {
	return A2(
		elm$random$Random$step,
		A2(elm$random$Random$int, 100, elm$random$Random$maxInt),
		elm$random$Random$initialSeed(
			elm$time$Time$posixToMillis(time))).a;
};
...
var author$project$Test$Runner$Node$App$initOrUpdate = F2(
	function (msg, maybeModel) {
		if (maybeModel.$ === 'Uninitialized') {
			var update = maybeModel.a;
			var maybeInitialSeed = maybeModel.b.maybeInitialSeed;
			var processes = maybeModel.b.processes;
			var report = maybeModel.b.report;
			var paths = maybeModel.b.paths;
			var runs = maybeModel.b.runs;
			var test = maybeModel.b.test;
			var init = maybeModel.b.init;
			if (msg.$ === 'Init') {
				var time = msg.a;
				var numericSeed = function () {
					if (maybeInitialSeed.$ === 'Just') {
						var givenNumericSeed = maybeInitialSeed.a;
						return givenNumericSeed;
					} else {
						return author$project$Test$Runner$Node$App$timeToNumericSeed(time);
					}
				}();
				var seed = elm$random$Random$initialSeed(numericSeed);
				var runners = A3(elm_explorations$test$Test$Runner$fromTest, runs, seed, test);
				var _n2 = init(
					{fuzzRuns: runs, initialSeed: numericSeed, paths: paths, processes: processes, report: report, runners: runners, startTime: time});
				var subModel = _n2.a;
				var subCmd = _n2.b;
				return _Utils_Tuple2(
					A2(author$project$Test$Runner$Node$App$Initialized, update, subModel),
					A2(elm$core$Platform$Cmd$map, author$project$Test$Runner$Node$App$SubMsg, subCmd));
			} else {
				return _Utils_Tuple2(maybeModel, elm$core$Platform$Cmd$none);
			}
		} else {
			var update = maybeModel.a;
			var model = maybeModel.b;
			if (msg.$ === 'SubMsg') {
				var subMsg = msg.a;
				var _n5 = A2(update, subMsg, model);
				var newModel = _n5.a;
				var cmd = _n5.b;
				return _Utils_Tuple2(
					A2(author$project$Test$Runner$Node$App$Initialized, update, newModel),
					A2(elm$core$Platform$Cmd$map, author$project$Test$Runner$Node$App$SubMsg, cmd));
			} else {
				return _Utils_Tuple2(maybeModel, elm$core$Platform$Cmd$none);
			}
		}
...
var author$project$Test$Runner$Node$App$subscriptions = F2(
	function (subs, model) {
		if (model.$ === 'Uninitialized') {
			...
			return A2(
				...
				author$project$Test$Runner$Node$App$SubMsg,
				subs(subModel));
		}
	});
var elm$core$Platform$worker = _Platform_worker;
var author$project$Test$Runner$Node$App$run = F3(
	function (_n0, appOpts, test) {
		var runs = _n0.runs;
		var seed = _n0.seed;
		var report = _n0.report;
		var paths = _n0.paths;
		...
		var init = function (args) {
			var cmd = A2(elm$core$Task$perform, author$project$Test$Runner$Node$App$Init, elm$time$Time$now);
			return _Utils_Tuple2(
				A2(
					author$project$Test$Runner$Node$App$Uninitialized,
					appOpts.update,
					{
						init: appOpts.init,
						...
						processes: processes,
						report: report,
						runs: A2(elm$core$Maybe$withDefault, author$project$Test$Runner$Node$App$defaultRunCount, runs),
						test: test
					}),
				cmd);
		};
		return elm$core$Platform$worker(
			{
				init: init,
				subscriptions: author$project$Test$Runner$Node$App$subscriptions(appOpts.subscriptions),
				update: author$project$Test$Runner$Node$App$initOrUpdate
			});
	});
var author$project$Test$Runner$Node$runWithOptions = function (options) {
	return A2(
		author$project$Test$Runner$Node$App$run,
		options,
		{
			init: author$project$Test$Runner$Node$init,
...
var author$project$TypeKindTests$all = A2(
	elm_explorations$test$Test$describe,
	'typekind decoder',
	_List_fromArray(
		[
			...
			function (_n0) {
				return A2(
					elm_explorations$test$Expect$equal,
					elm$core$Result$Ok(author$project$Graphql$Parser$TypeKind$Scalar),
					A2(elm$json$Json$Decode$decodeString, author$project$Graphql$Parser$TypeKind$decoder, '\"SCALAR\"'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'decodes TypeKind',
			function (_n1) {
				return A2(
					elm_explorations$test$Expect$equal,
					elm$core$Result$Ok(author$project$Graphql$Parser$TypeKind$NonNull),
					A2(elm$json$Json$Decode$decodeString, author$project$Graphql$Parser$TypeKind$decoder, '\"NON_NULL\"'));
			})
		]));
var author$project$TypeTests$all = A2(
	elm_explorations$test$Test$describe,
	'typekind decoder',
	_List_fromArray(
		[
			...
			function (_n0) {
				return A2(
					elm_explorations$test$Expect$equal,
					elm$core$Result$Ok(
						author$project$Graphql$Parser$Type$RawTypeRef(
							{
								kind: author$project$Graphql$Parser$TypeKind$NonNull,
								name: elm$core$Maybe$Nothing,
								ofType: elm$core$Maybe$Just(
									author$project$Graphql$Parser$Type$RawTypeRef(
										{
											kind: author$project$Graphql$Parser$TypeKind$Scalar,
											name: elm$core$Maybe$Just('String'),
											ofType: elm$core$Maybe$Nothing
										}))
							})),
					A2(elm$json$Json$Decode$decodeString, author$project$Graphql$Parser$Type$typeRefDecoder, '\n                {\n                  "ofType": {\n                    "ofType": null,\n                    "name": "String",\n                    "kind": "SCALAR"\n                  },\n                  "name": null,\n                  "kind": "NON_NULL"\n                }\n               '));
			}),
			A2(
			elm_explorations$test$Test$test,
			...
			function (_n1) {
				return A2(
					...
					elm$core$Result$Ok(
						author$project$Graphql$Parser$Type$RawTypeRef(
							{
								kind: author$project$Graphql$Parser$TypeKind$List,
								name: elm$core$Maybe$Nothing,
								ofType: elm$core$Maybe$Just(
									author$project$Graphql$Parser$Type$RawTypeRef(
										{
			...
			function (_n2) {
				return A2(
					...
					A2(
						...
						author$project$Graphql$Parser$Type$Scalar(author$project$Graphql$Parser$Scalar$String),
						author$project$Graphql$Parser$Type$Nullable),
					author$project$Graphql$Parser$Type$parseRef(
						author$project$Graphql$Parser$Type$RawTypeRef(
							{
								kind: author$project$Graphql$Parser$TypeKind$Scalar,
								name: elm$core$Maybe$Just('String'),
			...
			function (_n3) {
				return A2(
					...
					A2(
						author$project$Graphql$Parser$Type$TypeReference,
						author$project$Graphql$Parser$Type$Scalar(author$project$Graphql$Parser$Scalar$Boolean),
						author$project$Graphql$Parser$Type$Nullable),
					author$project$Graphql$Parser$Type$parseRef(
						author$project$Graphql$Parser$Type$RawTypeRef(
							{
								kind: author$project$Graphql$Parser$TypeKind$Scalar,
								name: elm$core$Maybe$Just('Boolean'),
								ofType: elm$core$Maybe$Nothing
							})));
			}),
			A2(
			elm_explorations$test$Test$test,
			'parseRaw non-nullable string',
			function (_n4) {
				return A2(
					elm_explorations$test$Expect$equal,
					A2(
			...
			A2(
			elm_explorations$test$Test$test,
			'parse non-null list of non-null strings',
			function (_n6) {
				return A2(
					elm_explorations$test$Expect$equal,
					A2(
...
var author$project$Test$Generated$Main1662723256$main = A2(
	author$project$Test$Runner$Node$runWithOptions,
	{
		paths: _List_Nil,
		processes: 48,
	...
	elm_explorations$test$Test$concat(
		_List_fromArray(
			[
				A2(
				elm_explorations$test$Test$describe,
				'Generator.AnnotatedArgTests',
				_List_fromArray(
					[author$project$Generator$AnnotatedArgTests$all])),
				A2(
				elm_explorations$test$Test$describe,
				'Generator.DocCommentTests',
				_List_fromArray(
					[author$project$Generator$DocCommentTests$all])),
				A2(
				elm_explorations$test$Test$describe,
				'Generator.EnumTests',
				_List_fromArray(
					[author$project$Generator$EnumTests$all])),
				A2(
				elm_explorations$test$Test$describe,
				'Generator.FieldTests',
				_List_fromArray(
					[author$project$Generator$FieldTests$all])),
				A2(
				elm_explorations$test$Test$describe,
				'Generator.ImportsTests',
				_List_fromArray(
					[author$project$Generator$ImportsTests$all])),
				A2(
				elm_explorations$test$Test$describe,
				'Generator.InputObjectLoopsTests',
				_List_fromArray(
					[author$project$Generator$InputObjectLoopsTests$all])),
				A2(
				elm_explorations$test$Test$describe,
				'Generator.ModuleNameTests',
				_List_fromArray(
					[author$project$Generator$ModuleNameTests$all])),
				A2(
				elm_explorations$test$Test$describe,
				'Generator.NormalizeTests',
				_List_fromArray(
					[author$project$Generator$NormalizeTests$all])),
				A2(
				elm_explorations$test$Test$describe,
				'Generator.OptionalArgsTests',
				_List_fromArray(
					[author$project$Generator$OptionalArgsTests$all])),
				A2(
				elm_explorations$test$Test$describe,
				'Generator.RequiredArgsTests',
				_List_fromArray(
					[author$project$Generator$RequiredArgsTests$all])),
				A2(
				elm_explorations$test$Test$describe,
				'Generator.TypeLockDefinitionsTests',
				_List_fromArray(
					[author$project$Generator$TypeLockDefinitionsTests$all])),
				A2(
				elm_explorations$test$Test$describe,
				'Parser.DecodeTests',
				_List_fromArray(
					[author$project$Parser$DecodeTests$all])),
				A2(
				elm_explorations$test$Test$describe,
				'TypeKindTests',
				_List_fromArray(
					[author$project$TypeKindTests$all])),
				A2(
				elm_explorations$test$Test$describe,
				'TypeTests',
				_List_fromArray(
					[author$project$TypeTests$all]))
			])));
_Platform_export({'Test':{'Generated':{'Main1662723256':{'init':author$project$Test$Generated$Main1662723256$main(elm$json$Json$Decode$value)(0)}}}});}(this));
return this.Elm;
})({});
var initialSeed = null;
var report = "console";
var pipeFilename = "/tmp/elm_test-4414.sock";
